...
Write-Host @"
Cringe people should kys.
Created by q2nDc/Examind
...
$hotkeyLabel.Text = "Hotkey: F6 | Made by q2nDc/Examind"
...
$hotkeyTextbox.Add_KeyDown({
    ...
    if ($script:capturingHotkey) {
        ...
        if ($vk -ne 1 -and $vk -ne 2 -and $vk -ne 4) {
            ...
            $hotkeyTextbox.BackColor = [System.Drawing.Color]::FromArgb(48, 48, 48)
            $hotkeyLabel.Text = "Hotkey: $($script:hotkeyName) | Made by q2nDc/Examind"
